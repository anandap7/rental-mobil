    ...
    <div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item">
					<a href="<?= base_url() ?>Owner/Home" class="nav-link <?= strpos($_SERVER['REQUEST_URI'], 'Owner/Home') == TRUE ? 'active' : '' ?>">
						<i class="nav-icon fas fa-chart-line"></i> Dashboard
					</a>
				</li>
				<li class="nav-item">
					<a href="<?= base_url() ?>Owner/Vehicle" class="nav-link <?= strpos($_SERVER['REQUEST_URI'], 'Owner/Vehicle') == TRUE ? 'active' : '' ?>">
